...
なぜ食性にこだわるかというと、私にとってゲームにおけるリアリティとは`没入感`だからだ。没入感を生むためには、「映像のディテールレベルに合わせて**不自然な箇所を無くしていく**」必要がある。そのためには物があるべきところにあるといった要素も重要になる。例えば植生がそれで、苔が生えるにしても自然なところに生える必要がある。そこでterrainにもプログラム的にシミュレーションする要素が必要になる。
